...
namespace IntroProgramacaoCSharp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Cinco linhas com o sinal de multiplicação do C#");
             ...
             * Console.WriteLine(“**”);
             */
            Console.WriteLine("Parecido com o anterior, porem o sinal é exibido como string");
            ...
            Console.Write("Insira o SOBRENOME do estudante: ");
            string sobrenome = Console.ReadLine();

            Console.Write("Insira a MATRÍCULA do estudante: ");
            string matricula = Console.ReadLine();


            // Não conhecia estes comandos, ForegroundColor, resetColor, bem bacana!
            ...
            Console.WriteLine("Insira dois números, diferentes de zero");
